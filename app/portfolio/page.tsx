...
export default function Portfolio() { 
  return ( 
    <div className="min-h-screen bg-gradient-to-b from-gray-100 to-white dark:from-gray-900 dark:to
gray-800 p-6"> 
      <div className="max-w-6xl mx-auto"> 
        <h1 className="text-4xl font-bold mb-2 text-blue-700 dark:text-blue-400">Dzlan</h1> 
        <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">Junior Web Developer</p> 
...
Unggulan</h2> 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6"> 
          {projects.map((project, index) => ( 
            <div key={index} className="bg-white dark:bg-gray-800 shadow-md hover:shadow-xl transition
